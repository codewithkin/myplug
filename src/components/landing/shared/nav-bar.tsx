...
function NavBar() {
    ...
    return (
        <motion.nav
            ...
            className="shadow-md dark:bg-white bg-slate-900 rounded-full w-full md:w-fit flex justify-between gap-4 md:gap-12 items-center py-4 px-8 fixed bottom-4 md:top-4 md:bottom-auto z-50"
        >
            <motion.h1
